...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.o: ../contracts/simple.token/simple.token.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/opt/eos2/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.o"
	cd /opt/eos2/eos/build/contracts/simple.token && /opt/rh/devtoolset-7/root/usr/bin/g++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/simple.token.tmp.dir/simple.token.cpp.o -c /opt/eos2/eos/contracts/simple.token/simple.token.cpp
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.i: cmake_force
	...
	cd /opt/eos2/eos/build/contracts/simple.token && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /opt/eos2/eos/contracts/simple.token/simple.token.cpp > CMakeFiles/simple.token.tmp.dir/simple.token.cpp.i
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.s: cmake_force
	...
	cd /opt/eos2/eos/build/contracts/simple.token && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /opt/eos2/eos/contracts/simple.token/simple.token.cpp -o CMakeFiles/simple.token.tmp.dir/simple.token.cpp.s
...
contracts/simple.token/simple.token.tmp: contracts/simple.token/CMakeFiles/simple.token.tmp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/opt/eos2/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable simple.token.tmp"
	cd /opt/eos2/eos/build/contracts/simple.token && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/simple.token.tmp.dir/link.txt --verbose=$(VERBOSE)
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/clean:
	cd /opt/eos2/eos/build/contracts/simple.token && $(CMAKE_COMMAND) -P CMakeFiles/simple.token.tmp.dir/cmake_clean.cmake
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/depend:
	cd /opt/eos2/eos/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/eos2/eos /opt/eos2/eos/contracts/simple.token /opt/eos2/eos/build /opt/eos2/eos/build/contracts/simple.token /opt/eos2/eos/build/contracts/simple.token/CMakeFiles/simple.token.tmp.dir/DependInfo.cmake --color=$(COLOR)
