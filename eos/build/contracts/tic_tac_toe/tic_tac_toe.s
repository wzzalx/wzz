...
_Z17is_valid_movementRKtS0_RKNSt3__16vectorIhNS1_9allocatorIhEEEE:
	...
	i32.add 	$push12=, $pop4, $pop5
	tee_local	$push11=, $1=, $pop12
	i32.load	$push0=, 4($2)
	i32.load	$push10=, 0($2)
	tee_local	$push9=, $2=, $pop10
	i32.sub 	$push1=, $pop0, $pop9
	i32.ge_u	$push6=, $pop11, $pop1
	br_if   	0, $pop6
	i32.add 	$push7=, $2, $1
...
_ZN11tic_tac_toe4moveERKyS1_S1_RKtS3_:
	...
	i32.const	$push68=, 80
	i32.sub 	$push96=, $pop67, $pop68
	tee_local	$push95=, $13=, $pop96
	i32.store	__stack_pointer($pop69), $pop95
	i64.load	$push0=, 0($3)
	call    	require_auth@FUNCTION, $pop0
	i64.const	$push1=, -1
	i64.store	56($13), $pop1
	i32.const	$push94=, 0
	i32.store	64($13), $pop94
	i64.load	$push93=, 0($0)
	tee_local	$push92=, $10=, $pop93
	i64.store	40($13), $pop92
	i64.load	$push91=, 0($2)
	tee_local	$push90=, $12=, $pop91
	i64.store	48($13), $pop90
	i32.const	$push2=, 68
	i32.add 	$push3=, $13, $pop2
	i32.const	$push89=, 0
	i32.store	0($pop3), $pop89
	i32.const	$push4=, 72
	i32.add 	$push5=, $13, $pop4
	i32.const	$push88=, 0
	i32.store	0($pop5), $pop88
	i32.const	$0=, 0
	block   	
	i64.const	$push7=, 7035937633859534848
	i64.load	$push6=, 0($1)
	i32.call	$push87=, db_find_i64@FUNCTION, $10, $12, $pop7, $pop6
	tee_local	$push86=, $1=, $pop87
	i32.const	$push85=, 0
	i32.lt_s	$push8=, $pop86, $pop85
	br_if   	0, $pop8
	i32.const	$push81=, 40
	i32.add 	$push82=, $13, $pop81
	i32.call	$push98=, _ZNK5eosio11multi_indexILy7035937633859534848EN11tic_tac_toe4gameEJEE31load_object_by_primary_iteratorEl@FUNCTION, $pop82, $1
	tee_local	$push97=, $0=, $pop98
	i32.load	$push9=, 44($pop97)
	i32.const	$push83=, 40
	i32.add 	$push84=, $13, $pop83
	i32.eq  	$push10=, $pop9, $pop84
	i32.const	$push11=, .L.str.13
	call    	eosio_assert@FUNCTION, $pop10, $pop11
.LBB24_2:
	end_block
	i32.const	$push101=, 0
	i32.ne  	$push100=, $0, $pop101
	tee_local	$push99=, $6=, $pop100
	i32.const	$push12=, .L.str.4
	call    	eosio_assert@FUNCTION, $pop99, $pop12
	i64.load	$7=, 24($0)
	i64.const	$10=, 0
	i64.const	$9=, 59
	i32.const	$1=, .L.str.1
...
.LBB24_3:
	...
	block   	
	i64.const	$push102=, 3
	i64.gt_u	$push13=, $10, $pop102
	br_if   	0, $pop13
	i32.load8_s	$push107=, 0($1)
	tee_local	$push106=, $2=, $pop107
	i32.const	$push105=, -97
	i32.add 	$push15=, $pop106, $pop105
	i32.const	$push104=, 255
	i32.and 	$push16=, $pop15, $pop104
	i32.const	$push103=, 25
	i32.gt_u	$push17=, $pop16, $pop103
	br_if   	1, $pop17
...
.LBB24_6:
	...
	i64.le_u	$push14=, $10, $pop109
	br_if   	2, $pop14
	br      	3
.LBB24_7:
	end_block
	i32.const	$push114=, 208
	i32.add 	$push18=, $2, $pop114
	i32.const	$push113=, 0
	i32.const	$push112=, -49
	i32.add 	$push19=, $2, $pop112
	i32.const	$push111=, 255
	i32.and 	$push20=, $pop19, $pop111
	i32.const	$push110=, 5
	i32.lt_u	$push21=, $pop20, $pop110
	i32.select	$2=, $pop18, $pop113, $pop21
.LBB24_8:
	end_block
	i64.extend_u/i32	$push22=, $2
	i64.const	$push116=, 56
	i64.shl 	$push23=, $pop22, $pop116
	i64.const	$push115=, 56
	i64.shr_s	$12=, $pop23, $pop115
.LBB24_9:
	end_block
	i64.const	$push118=, 31
	i64.and 	$push25=, $12, $pop118
	i64.const	$push117=, 4294967295
	i64.and 	$push24=, $9, $pop117
...
.LBB24_10:
	...
	i32.add 	$1=, $1, $pop124
	i64.const	$push123=, 1
	i64.add 	$10=, $10, $pop123
	i64.or  	$11=, $12, $11
	i64.const	$push122=, -5
	i64.add 	$push121=, $9, $pop122
	tee_local	$push120=, $9=, $pop121
	i64.const	$push119=, -6
	i64.ne  	$push26=, $pop120, $pop119
	br_if   	0, $pop26
	end_loop
	i64.eq  	$push27=, $7, $11
	...
	i32.const	$1=, 1
	block   	
	i64.load	$push126=, 0($3)
	tee_local	$push125=, $10=, $pop126
	i64.load	$push29=, 8($0)
	i64.eq  	$push30=, $pop125, $pop29
	br_if   	0, $pop30
	i64.load	$push31=, 0($0)
	i64.eq  	$1=, $10, $pop31
.LBB24_13:
	...
	i32.const	$1=, 0
	block   	
	i32.load16_u	$push41=, 0($4)
	i32.const	$push42=, 3
	i32.mul 	$push43=, $pop41, $pop42
	i32.load16_u	$push44=, 0($5)
	i32.add 	$push130=, $pop43, $pop44
	tee_local	$push129=, $3=, $pop130
	i32.const	$push37=, 36
	i32.add 	$push38=, $0, $pop37
	i32.load	$push39=, 0($pop38)
	i32.load	$push128=, 32($0)
	tee_local	$push127=, $8=, $pop128
	i32.sub 	$push40=, $pop39, $pop127
	i32.ge_u	$push45=, $pop129, $pop40
	br_if   	0, $pop45
	i32.add 	$push46=, $8, $3
...
.LBB24_15:
	end_block
	i32.const	$push48=, .L.str.8
	call    	eosio_assert@FUNCTION, $1, $pop48
	i32.const	$push55=, 1
	i32.const	$push54=, 2
	i32.const	$push51=, 16
	...
	i64.load	$push137=, 0($pop50)
	tee_local	$push136=, $10=, $pop137
	i64.eq  	$push135=, $pop53, $pop136
	tee_local	$push134=, $1=, $pop135
	i32.select	$push56=, $pop55, $pop54, $pop134
	i32.store8	39($13), $pop56
	i32.select	$push57=, $0, $2, $1
	i64.load	$push58=, 0($pop57)
	i64.store	24($13), $pop58
	i32.store	12($13), $5
	i32.store	8($13), $4
	i32.const	$push73=, 39
	i32.add 	$push74=, $13, $pop73
	i32.store	16($13), $pop74
	i32.const	$push75=, 24
	i32.add 	$push76=, $13, $pop75
	i32.store	20($13), $pop76
	...
	call    	_ZN5eosio11multi_indexILy7035937633859534848EN11tic_tac_toe4gameEJEE6modifyIZNS1_4moveERKyS6_S6_RKtS8_E3$_2EEvRKS2_yOT_@FUNCTION, $pop78, $0, $10, $pop80
	block   	
	i32.load	$push133=, 64($13)
	...
	block   	
	i32.const	$push60=, 68
	i32.add 	$push141=, $13, $pop60
	tee_local	$push140=, $4=, $pop141
	i32.load	$push139=, 0($pop140)
	tee_local	$push138=, $1=, $pop139
	i32.eq  	$push61=, $pop138, $3
	br_if   	0, $pop61
.LBB24_18:
	loop    	
	i32.const	$push145=, -24
	i32.add 	$push144=, $1, $pop145
	tee_local	$push143=, $1=, $pop144
	i32.load	$2=, 0($pop143)
	i32.const	$push142=, 0
	i32.store	0($1), $pop142
	block   	
	i32.eqz 	$push150=, $2
	br_if   	0, $pop150
	block   	
	i32.load	$push147=, 32($2)
	tee_local	$push146=, $0=, $pop147
	i32.eqz 	$push151=, $pop146
	br_if   	0, $pop151
	i32.const	$push148=, 36
	i32.add 	$push62=, $2, $pop148
	i32.store	0($pop62), $0
	call    	_ZdlPv@FUNCTION, $0
.LBB24_21:
	end_block
